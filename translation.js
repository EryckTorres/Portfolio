...
const translations = { 
  en: {
    ...
    contactText: "Ready for the next challenge! Get in touch to discuss how we can bring together design and technology in your project.",
  ...
  pt: {
    ...
    contactText: "Pronto para o próximo desafio! Entre em contato para discutirmos como podemos unir design e tecnologia no seu projeto.",
  ...
  es: {
    ...
    contactText: "¡Listo para el próximo desafío! Ponte en contacto para hablar sobre cómo podemos unir diseño y tecnología en tu proyecto.",
  ...
  fr: {
    ...
    contactText: "Prêt pour le prochain défi ! Contactez-moi pour discuter comment nous pouvons allier design et technologie dans votre projet.",
    placeholderName: "Nom",
    placeholderEmail: "E-mail",
